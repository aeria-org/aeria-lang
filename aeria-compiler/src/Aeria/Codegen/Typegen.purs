...
typegen (Js.Function params body) = Ts.type_ $ Ts.typeFunction (map typegenParameter params) (typegen body)
typegen (Js.Object value) = (Ts.type_ <<< Ts.typeObject) (map typegenObjectProperty value)
...
typegenObjectProperty :: Js.ObjectProperty -> Ts.TypeObjectProperty
typegenObjectProperty (Js.ObjectProperty1 identifier@(Js.Identifier i)) =
  Ts.typeObjectProperty (typegenIdentifier identifier) (Ts.typeQuery (Ts.variable i))
typegenObjectProperty (Js.ObjectProperty2 ident tree) =
  Ts.typeObjectProperty (typegenIdentifier ident) (typegen tree)

typegenParameter :: Js.Identifier -> Tuple Ts.Identifier Ts.Tree
typegenParameter ident = typegenIdentifier ident /\ Ts.type_ Ts.typeAny
