...
var permToString = /* #__PURE__ */ (function () {
    var $129 = Data_Show.show(Data_Show.showInt);
    return function ($130) {
...
var permsToInt = /* #__PURE__ */ (function () {
    var $131 = Data_Int.fromStringAs(Data_Int.octal);
    return function ($132) {
        return fromJust($131(permsToString($132)));
    };
})();
...
var permsFromString = /* #__PURE__ */ (function () {
    ...
    var $133 = dropPrefix(zeroChar);
    return function ($134) {
        return _perms(Data_String_CodeUnits.toCharArray($133($134)));
    };
})();
...
var showPerms = {
    show: function (v) {
        var f = function (perm) {
            var str = show(perm);
            var $125 = Data_Maybe.isNothing(Data_String_CodePoints.indexOf(" ")(str));
            if ($125) {
                return str;
            };
            return "(" + (str + ")");
