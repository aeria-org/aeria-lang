...
var bimap = /* #__PURE__ */ Data_Bifunctor.bimap(Test_Spec_Tree.bifunctorTree);
var any = /* #__PURE__ */ Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean);
var any1 = /* #__PURE__ */ Data_Foldable.any(Test_Spec_Tree.foldableTree)(Data_HeytingAlgebra.heytingAlgebraBoolean);
        ...
        return function ($$var) {
            return function (action) {
                return bind(liftAff(Effect_Aff_AVar.take($$var)))(function (v) {
                    ...
                    throw new Error("Failed pattern match at Test.Spec (line 317, column 31 - line 323, column 33): " + [ v.constructor.name ]);
                });
            };
        };
    };
...
var hoistSpec = function (dictMonad) {
    ...
    return function (onM) {
        return function (f) {
            ...
            return mapSpecTree1(onM)(Test_Spec_Tree.bimapTreeWithPaths(onCleanUp)(onTest));
        };
    };
};
